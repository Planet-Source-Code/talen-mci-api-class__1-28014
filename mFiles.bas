...
Dim hItem&, hHandle&
'Эти две переменные не могут быть статическими,
'т.к. они должны быть reinit каждый раз!
'Мы ведь через каждую директорию скроллимся!
Dim dirs%, dirbuf$(), i%
...
If artist$ = "Неизвестный исполнитель" Then artist$ = ""
